...
class DrumsMission(SAUVCMission):
    ...
    def setup_states(self):
        return ('move_march', 'condition_search_drums', 'condition_centering_drums', 'custom_stop', 'custom_centering', 'custom_drop', 'move_back')

    def setup_transitions(self):
        transitions = [
            [self.machine.transition_start,
                self.machine.state_init, 'condition_search_drums'],
