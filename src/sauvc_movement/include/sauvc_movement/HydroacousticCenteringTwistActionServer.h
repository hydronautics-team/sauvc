...
#include <sauvc_interfaces/action/hydroacoustic_centering_twist_action.hpp>
 ...
 * by march and lag.
 */
class HydroacousticCenteringTwistActionServer : public AbstractCenteringTwistActionServer<sauvc_interfaces::action::HydroacousticCenteringTwistAction, sauvc_interfaces::action::HydroacousticCenteringTwistAction_Goal> {
...
private:
    bool isTwistDone(const std::shared_ptr<const sauvc_interfaces::action::HydroacousticCenteringTwistAction_Goal> goal)  override;
    ...
    void execute(const std::shared_ptr<rclcpp_action::ServerGoalHandle<sauvc_interfaces::action::HydroacousticCenteringTwistAction>> goal_handle) override;
