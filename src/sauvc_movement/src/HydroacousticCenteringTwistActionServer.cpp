#include "sauvc_movement/HydroacousticCenteringTwistActionServer.h"

HydroacousticCenteringTwistActionServer::HydroacousticCenteringTwistActionServer(std::shared_ptr<rclcpp::Node> _node, const std::string &actionName) : AbstractCenteringTwistActionServer<sauvc_interfaces::action::HydroacousticCenteringTwistAction, sauvc_interfaces::action::HydroacousticCenteringTwistAction_Goal>(_node, actionName) {
...
bool HydroacousticCenteringTwistActionServer::isTwistDone(const std::shared_ptr<const sauvc_interfaces::action::HydroacousticCenteringTwistAction_Goal> goal) {
