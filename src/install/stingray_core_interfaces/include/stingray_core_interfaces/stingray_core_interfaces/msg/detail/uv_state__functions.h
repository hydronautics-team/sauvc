...
#ifndef STINGRAY_CORE_INTERFACES__MSG__DETAIL__UV_STATE__FUNCTIONS_H_
#define STINGRAY_CORE_INTERFACES__MSG__DETAIL__UV_STATE__FUNCTIONS_H_
 ...
 * calls
 * stingray_core_interfaces__msg__UVState__init().
...
/**
 * It calls
 * stingray_core_interfaces__msg__UVState__fini()
 ...
 * stingray_core_interfaces__msg__UVState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * stingray_core_interfaces__msg__UVState__Sequence__fini()
 * on the array,
...
#endif  // STINGRAY_CORE_INTERFACES__MSG__DETAIL__UV_STATE__FUNCTIONS_H_
