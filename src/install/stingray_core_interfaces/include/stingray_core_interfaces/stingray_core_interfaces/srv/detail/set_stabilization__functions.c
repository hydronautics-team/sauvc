...
stingray_core_interfaces__srv__SetStabilization_Request__create()
{
  ...
  stingray_core_interfaces__srv__SetStabilization_Request * msg = (stingray_core_interfaces__srv__SetStabilization_Request *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stingray_core_interfaces__srv__SetStabilization_Request));
  bool success = stingray_core_interfaces__srv__SetStabilization_Request__init(msg);
  if (!success) {
...
stingray_core_interfaces__srv__SetStabilization_Request__destroy(stingray_core_interfaces__srv__SetStabilization_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    stingray_core_interfaces__srv__SetStabilization_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
stingray_core_interfaces__srv__SetStabilization_Request__Sequence__init(stingray_core_interfaces__srv__SetStabilization_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Request * data = NULL;

  if (size) {
    data = (stingray_core_interfaces__srv__SetStabilization_Request *)allocator.zero_allocate(size, sizeof(stingray_core_interfaces__srv__SetStabilization_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stingray_core_interfaces__srv__SetStabilization_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        stingray_core_interfaces__srv__SetStabilization_Request__fini(&data[i - 1]);
      }
...
stingray_core_interfaces__srv__SetStabilization_Request__Sequence__fini(stingray_core_interfaces__srv__SetStabilization_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      stingray_core_interfaces__srv__SetStabilization_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Request__Sequence * array = (stingray_core_interfaces__srv__SetStabilization_Request__Sequence *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stingray_core_interfaces__srv__SetStabilization_Request__Sequence__init(array, size);
  if (!success) {
...
stingray_core_interfaces__srv__SetStabilization_Request__Sequence__destroy(stingray_core_interfaces__srv__SetStabilization_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stingray_core_interfaces__srv__SetStabilization_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stingray_core_interfaces__srv__SetStabilization_Request__Sequence__are_equal(const stingray_core_interfaces__srv__SetStabilization_Request__Sequence * lhs, const stingray_core_interfaces__srv__SetStabilization_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stingray_core_interfaces__srv__SetStabilization_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stingray_core_interfaces__srv__SetStabilization_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stingray_core_interfaces__srv__SetStabilization_Request * data =
      (stingray_core_interfaces__srv__SetStabilization_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stingray_core_interfaces__srv__SetStabilization_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stingray_core_interfaces__srv__SetStabilization_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Request__copy(
...
stingray_core_interfaces__srv__SetStabilization_Response__init(stingray_core_interfaces__srv__SetStabilization_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    stingray_core_interfaces__srv__SetStabilization_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Response * msg = (stingray_core_interfaces__srv__SetStabilization_Response *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stingray_core_interfaces__srv__SetStabilization_Response));
  bool success = stingray_core_interfaces__srv__SetStabilization_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stingray_core_interfaces__srv__SetStabilization_Response__Sequence__init(stingray_core_interfaces__srv__SetStabilization_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Response * data = NULL;

  if (size) {
    data = (stingray_core_interfaces__srv__SetStabilization_Response *)allocator.zero_allocate(size, sizeof(stingray_core_interfaces__srv__SetStabilization_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stingray_core_interfaces__srv__SetStabilization_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stingray_core_interfaces__srv__SetStabilization_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stingray_core_interfaces__srv__SetStabilization_Response__Sequence__fini(stingray_core_interfaces__srv__SetStabilization_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stingray_core_interfaces__srv__SetStabilization_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Response__Sequence * array = (stingray_core_interfaces__srv__SetStabilization_Response__Sequence *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stingray_core_interfaces__srv__SetStabilization_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stingray_core_interfaces__srv__SetStabilization_Response__Sequence__destroy(stingray_core_interfaces__srv__SetStabilization_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stingray_core_interfaces__srv__SetStabilization_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stingray_core_interfaces__srv__SetStabilization_Response__Sequence__are_equal(const stingray_core_interfaces__srv__SetStabilization_Response__Sequence * lhs, const stingray_core_interfaces__srv__SetStabilization_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stingray_core_interfaces__srv__SetStabilization_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stingray_core_interfaces__srv__SetStabilization_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stingray_core_interfaces__srv__SetStabilization_Response * data =
      (stingray_core_interfaces__srv__SetStabilization_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stingray_core_interfaces__srv__SetStabilization_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stingray_core_interfaces__srv__SetStabilization_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
stingray_core_interfaces__srv__SetStabilization_Event__init(stingray_core_interfaces__srv__SetStabilization_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    stingray_core_interfaces__srv__SetStabilization_Event__fini(msg);
    return false;
  }
  // request
  if (!stingray_core_interfaces__srv__SetStabilization_Request__Sequence__init(&msg->request, 0)) {
    stingray_core_interfaces__srv__SetStabilization_Event__fini(msg);
    return false;
  }
  // response
  if (!stingray_core_interfaces__srv__SetStabilization_Response__Sequence__init(&msg->response, 0)) {
    stingray_core_interfaces__srv__SetStabilization_Event__fini(msg);
    return false;
  }
  return true;
...
stingray_core_interfaces__srv__SetStabilization_Event__fini(stingray_core_interfaces__srv__SetStabilization_Event * msg)
{
  ...
  // request
  stingray_core_interfaces__srv__SetStabilization_Request__Sequence__fini(&msg->request);
  // response
  stingray_core_interfaces__srv__SetStabilization_Response__Sequence__fini(&msg->response);
}
...
stingray_core_interfaces__srv__SetStabilization_Event__are_equal(const stingray_core_interfaces__srv__SetStabilization_Event * lhs, const stingray_core_interfaces__srv__SetStabilization_Event * rhs)
{
  ...
  // request
  if (!stingray_core_interfaces__srv__SetStabilization_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!stingray_core_interfaces__srv__SetStabilization_Response__Sequence__are_equal(
  ...
  stingray_core_interfaces__srv__SetStabilization_Event * output)
{
  ...
  // request
  if (!stingray_core_interfaces__srv__SetStabilization_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!stingray_core_interfaces__srv__SetStabilization_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Event * msg = (stingray_core_interfaces__srv__SetStabilization_Event *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(stingray_core_interfaces__srv__SetStabilization_Event));
  bool success = stingray_core_interfaces__srv__SetStabilization_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
stingray_core_interfaces__srv__SetStabilization_Event__Sequence__init(stingray_core_interfaces__srv__SetStabilization_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Event * data = NULL;

  if (size) {
    data = (stingray_core_interfaces__srv__SetStabilization_Event *)allocator.zero_allocate(size, sizeof(stingray_core_interfaces__srv__SetStabilization_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = stingray_core_interfaces__srv__SetStabilization_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        stingray_core_interfaces__srv__SetStabilization_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
stingray_core_interfaces__srv__SetStabilization_Event__Sequence__fini(stingray_core_interfaces__srv__SetStabilization_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      stingray_core_interfaces__srv__SetStabilization_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  stingray_core_interfaces__srv__SetStabilization_Event__Sequence * array = (stingray_core_interfaces__srv__SetStabilization_Event__Sequence *)allocator.allocate(sizeof(stingray_core_interfaces__srv__SetStabilization_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = stingray_core_interfaces__srv__SetStabilization_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
stingray_core_interfaces__srv__SetStabilization_Event__Sequence__destroy(stingray_core_interfaces__srv__SetStabilization_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    stingray_core_interfaces__srv__SetStabilization_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
stingray_core_interfaces__srv__SetStabilization_Event__Sequence__are_equal(const stingray_core_interfaces__srv__SetStabilization_Event__Sequence * lhs, const stingray_core_interfaces__srv__SetStabilization_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  stingray_core_interfaces__srv__SetStabilization_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(stingray_core_interfaces__srv__SetStabilization_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    stingray_core_interfaces__srv__SetStabilization_Event * data =
      (stingray_core_interfaces__srv__SetStabilization_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!stingray_core_interfaces__srv__SetStabilization_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          stingray_core_interfaces__srv__SetStabilization_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!stingray_core_interfaces__srv__SetStabilization_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
